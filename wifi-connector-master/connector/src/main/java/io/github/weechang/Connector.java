...
public class Connector {
     ...
     * 密码路径
     */
    public static final String PASSWORD_PATH = "F:\\asd\\password\\wake.txt";

    /**
     * 配置文件暂时存放路径
     */
    public static final String PROFILE_TEMP_PATH = "F:\\asd\\profile";

    /**
     * 破解成功wifi存放路径
     */
    public static final String RESULT_PATH = "F:\\asd\\record.txt";

    /**
     * 日志存放路径
     */
    public static final String LOG_PATH = "F:\\asd\\log.txt";
